...
const NavBar = () => {
  ...
  return (
    <div className="z-100 hidden sm:flex flex-row bg-transparent absolute right-0 justify-center items-center h-[90vh] gap-4 pr-4">
      <div className="h-[150px] flex flex-col gap-3 justify-center text-[14px]">

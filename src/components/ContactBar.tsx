...
const ContactBar = () => {
  return (
    <div className="z-[11] mb-5 absolute bg-transparent sm:left-0 bottom-0 left-0 sm:w-[50px] top-10 sm:pb-0 h-[90vh] justify-center sm:items-center items-end sm:pl-4 pl-0 sm:flex-col flex-row w-full gap-4 flex">

...
const ContactBar = () => {
  return (
    <div className="mb-5 absolute sm:left-0 bottom-0 left-0 sm:w-[50px]  sm:pb-0 h-[90vh] justify-center sm:items-center items-end sm:pl-4 pl-0 sm:flex-col flex-row w-full gap-4 flex ">
